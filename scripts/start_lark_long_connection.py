...
CODEX_FRAMING = (
    ...
    "- 「幫我抓 X 群的語氣樣本 / 補一下 X 群的真實語料 / X 群最近講話風格不太一樣」→ harvest_style_samples。\n"
    "  · 工具會自動 navigate 進去讀 200 則，篩出自然成員語句，top 30 寫進 voice_profile.md 的 auto-managed 區塊。\n"
    "  · 回報時告訴操作員寫入了幾句 + 預覽 3-5 句即可。\n"
